...
public final class StdDraw {
    ...
    public static void filledCircle(double x, double y, double r) {
        double xs = scaleX(x);
        double ys = scaleY(y);
        double ws = r * canvasWidth / (xmax - xmin);
        double hs = r * canvasHeight / (ymax - ymin);
        offscreen.fill(new Ellipse2D.Double(xs - ws, ys - hs, 2 * ws, 2 * hs));
        drawIfNeeded();
    }
    ...
    public static void circle(double x, double y, double r) {
        ...
        double ws = r * canvasWidth / (xmax - xmin);
        double hs = r * canvasHeight / (ymax - ymin);
        offscreen.draw(new Ellipse2D.Double(xs - ws, ys - hs, 2 * ws, 2 * hs));
        drawIfNeeded();
    }

    public static void setFont() {
        offscreen.setFont(new java.awt.Font("SansSerif", java.awt.Font.PLAIN, 12));
    }
    ...
    public static void text(double x, double y, String text) {
        ...
        int ws = fm.stringWidth(text);
        int hs = fm.getAscent();
        offscreen.drawString(text, (float) (xs - ws / 2.0), (float) (ys + hs / 2.0));
        drawIfNeeded();
    }
    ...
    /**
     * Salva o canvas atual em um arquivo de imagem (PNG).
     */
